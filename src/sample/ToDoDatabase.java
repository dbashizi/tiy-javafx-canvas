...
public class ToDoDatabase {
    ...
    public void init() throws SQLException {
        // we'll add some implementation code here once we have a unit test method for
    ...
    public DataUser selectUser(Connection conn, String username) throws SQLException {
      ...
      PreparedStatement stmt = conn.prepareStatement("SELECT * FROM users where username = ?");
        ...
        if (!storedResults) {
            ...
            newUser = new DataUser(resultID, resultUserFullName, resultUsername);
    ...
    public int insertUser(Connection conn, String username, String fullname) throws SQLException {    PreparedStatement stmt = conn.prepareStatement("INSERT INTO users VALUES (NULL, ?, ?)");
    ...
    public static void toggleToDo(Connection conn, int id) throws SQLException {
        ...
        stmt.setInt(1, id); // all counts start @ 1
        stmt.execute();
